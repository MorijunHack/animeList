            ...
            <div>
                ...
                <div className={classes.textLeft}>
                    <Paper className={classes.root} elevation={1}>
                        <Typography variant="headline" conponent="h3">
                            Animelとは
                        </Typography>
                        <Typography component="p">
                            今期のアニメから過去のアニメまで、情報を一覧表示するアプリ。各クールのアニメ、タイトル、サブタイトル、ハッシュタグ、Twitter、公式サイトを一覧表示します。2014年以降のアニメに対応しております。
                        </Typography>
                    </Paper>
                    ...
                    <Paper className={classes.root} elevation={1}>
                        ...
                        <Typography component="p" className={classes.paragraph}>
                            本アプリでは夏季技術を用いており、各サービスの仕様変更ならびに障害発生時には、本アプリの提供・公開を中断する場合もございます。あらかじめご了承ください。
                        </Typography>
                        <Typography component="div" className={classes.paragraph}>
                            <ul>
                                <li>Firebase Hosting</li>
                                <li>Shanglira AnimeAPI V1</li>
